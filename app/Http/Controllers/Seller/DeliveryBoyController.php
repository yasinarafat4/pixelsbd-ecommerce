...
class DeliveryBoyController extends Controller
{
    ...
    {
        $delivery_boys = DeliveryBoy::where('creator_type', 'seller')->with('city')->where('creator_id', auth('seller')->user()->id)->latest()->paginate(10);
        return Inertia::render('Seller/Plugins/DeliveryBoy/AllDeliveryBoys', [
    ...
    public function create_delivery_boy()
    {
        ...
        return Inertia::render('Seller/Plugins/DeliveryBoy/Create', [
            'countries' => $countries
        ]);
    }
    public function store(Request $request)
    {
        $request->validate([
            'name' => 'required',
            'email' => 'required|string|lowercase|email|max:255|unique:delivery_boys',
            'phone' => 'required',
            'password' => 'required',
            'country_id' => 'required',
            'state_id' => 'required',
        ...
        $delivery_boy->creator_id = auth('seller')->user()->id;
        $delivery_boy->creator_type = auth('seller')->user()->user_type;
        ...
        $delivery_boy->save();
        return redirect()->route('seller.deliveryboy.all_delivery_boys')->with('success', 'Delivery Boy Created Successfully!');
    }
    ...
    public function edit_delivery_boy($id)
    {
        ...
        $countries = Country::active()->get();
        return Inertia::render('Seller/Plugins/DeliveryBoy/Edit', [
    ...
    public function update(Request $request, $id)
    {
        ...
        $delivery_boy->address = $request->address;
        $delivery_boy->save();
        return redirect()->route('seller.deliveryboy.all_delivery_boys')->with('success', 'Delivery Boy Updated Successfully!');
    }
    ...
    public function payment_histories(Request $request)
    {
        ...
        return Inertia::render('Seller/Plugins/DeliveryBoy/PaymentHistories', [
            'payments' => $payments
        ]);
    }
    ...
    public function collected_histories(Request $request)
    {
        ...
        return Inertia::render('Seller/Plugins/DeliveryBoy/CollectedHistories', [
    ...
    public function cancel_request(Request $request)
    {
        ...
        return Inertia::render('Seller/Plugins/DeliveryBoy/CancelRequest', [
    ...
    {
        return Inertia::render('Seller/Plugins/DeliveryBoy/Configuration');
    }
