...
use App\Http\Resources\Api\CitiesCollection;
use App\Http\Resources\Api\CountriesCollection;
use App\Http\Resources\Api\StatesCollection;
...
class AddressController extends Controller
{
    ...
    public function updateAddressInCart(Request $request)
    {
        ...
        $address[] = null;
        if (get_settings('guest_checkout') == 0 && $authUser == null) {
            return response()->json([
                'result' => false,
        ...
        if ($authUser != null) {
            ...
            if (get_settings('guest_checkout') == 1) {
                if (
