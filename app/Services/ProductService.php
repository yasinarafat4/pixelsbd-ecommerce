...
class ProductService
{
    public function store(array $data)
    {
        ...
        $collection['gallery_image'] = implode(',', $collection['gallery_image']);
        ...
        if ($collection['meta_image'] == null) {
            $collection['meta_image'] = $collection['thumbnail_image'];
        }
        ...
        $attributes = array();
        if (isset($collection['variant_product']) && $collection['variant_product']) {
            ...
            if (isset($collection['choice_no']) && $collection['choice_no']) {
                ...
                foreach ($collection['choice_no'] as $key => $no) {
                    ...
                    $item['attribute'] = $collection['choice'][$key];
    ...
    public function update(array $data, Product $product)
    {
        ...
        $name = [$collection['lang'] => $collection['name']];
        ...
        $description = [$collection['lang'] => $collection['description']];
        ...
        unset($collection['shipping_cost']);
    ...
    public function product_duplicate_store($product)
    {
        ...
        $product_new->approved = (get_settings('product_approve_by_admin') == 1 && $product->added_by != 'admin') ? 0 : 1;
        $product_new->save();
