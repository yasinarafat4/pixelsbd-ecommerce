...
export default function ConversationDetails ( { conversation } )
{
    ...
    {
        router.post( route( 'seller.seller_replay.store' ), {
            message: message,
    ...
    return (
        <SellerLayout>
            ...
            <div  className="text-sm breadcrumbs text-slate-600 p-4">
                <ul>
                    <li>
                        <a href={ route( 'seller.conversation' ) }  className="inline-flex gap-1 items-center">
            ...
            <div  className='border rounded-t-md max-w-7xl mx-auto'>
                <div  className='bg-[#F5F5F5] border-b px-8 py-4'>
                    ...
                    <p  className='flex items-center gap-2'> <TbMessage  className='text-xl' /> <span  className='text-sm'>Between you and <Link  className='font-semibold'>{ conversation.sender.name }</Link></span> </p>
                                ...
                                return <div key={ i }>
                                    {
                                        ...
                                        <div  className="chat chat-start my-3">
                                            ...
                                            <div  className="chat-bubble  break-words">{ msg.messages }</div>
                                        </div>
                                    }
