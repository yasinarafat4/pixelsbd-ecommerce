                        ...
                        <ul>
                            ...
                            <li>
                                <span  className="inline-flex gap-1 items-center">
                                    ...
                                    <span>{t('All Cancel Request')}</span>
                                </span>
                            </li>
                        </ul>
                    </div>
...

                                    {
                                        cancel_requests.data.map((cancel_request, i) => (
                                            <tr key={i}>
                                                ...
                                                <td align="left">
                                                    <Link href={route('seller.seller_orders_view', window.btoa(cancel_request.id))}><div data-tip={t('View')}  className="tooltip cursor-pointer p-[10px] text-slate-700 border border-slate-500 hover:text-slate-200 bg-[#fff] hover:bg-[#A179F0] hover:border-[#A179F0] duration-500 rounded-full">
