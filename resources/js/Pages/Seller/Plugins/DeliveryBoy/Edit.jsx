...
export default function Edit ( { countries, delivery_boy } )
{
    ...
    {
        e.preventDefault()
        put( route( 'seller.deliveryboy.update_delivery_boy', delivery_boy.id ) )
    }
                    ...
                    <form onSubmit={ e => handleSubmit( e ) }>
                        <div  className='grid grid-cols-1 items-center gap-2 px-4 py-6'>
                            ...
                            <div>
                                ...
                                <select value={ data.document_type } onChange={ e => setData( 'document_type', e.target.value ) }  className="select select-bordered focus:outline-none w-full">
                            ...
                            { data.document_type == 'nid' && <div>
                                {/* NID Front Side*/ }
                                <div  className='flex flex-col w-full'>
                                    <label  className='label-text text-slate-600 text-sm'>
                                        { t( 'Front Side' ) } <span  className="text-red-600">*</span>
                                    </label>
                                    <div  className="w-full">
                                        <div
                                        ...
                                        <div  className="flex items-center gap-3">
                                            { data.nid_front && <div  className="relative">
                                                ...
                                                <img  className='w-32 h-32 border rounded-xl p-3 mt-3' src={ data.nid_front } alt={ 'NID Front Side' } />
                                            </div> }
                                        </div>
                                    </div>
                                ...
                                <div  className='flex flex-col w-full'>
                                    <label  className='label-text text-slate-600 text-sm'>
                                        { t( 'Back Side' ) } <span  className="text-red-600">*</span>
                                    </label>
                                    <div  className="w-full">
                                        <div
                                        ...
                                        <div  className="flex items-center gap-3">
                                            { data.nid_back && <div  className="relative">
                                                ...
                                                <img  className='w-32 h-32 border rounded-xl p-3 mt-3' src={ data.nid_back } alt={ 'NID Back Side' } />
                                            </div> }
                                        </div>
                                    </div>
                            ...
                            { data.document_type == 'passport' && <div  className='flex flex-col w-full'>
                                <label  className='label-text text-slate-600 text-sm'>
                                    { t( 'Passport' ) } <span  className="text-red-600">*</span>
                                </label>
                                <div  className="w-full">
                                    <div
                                    ...
                                    <div  className="flex items-center gap-3">
                                        { data.passport && <div  className="relative">
                                            ...
                                            <img  className='w-32 h-32 border rounded-xl p-3 mt-3' src={ data.passport } alt={ 'Passport' } />
                                        </div> }
                                    </div>
                                </div>
