...
export default function Create ( { countries } )
{
    ...
    {
        e.preventDefault()
        post( route( 'seller.deliveryboy.store_delivery_boy' ) )
    }
                ...
                <div  className='card rounded shadow bg-white border-[1px] border-slate-200 py-5 max-w-4xl mx-auto'>
                    ...
                    <form onSubmit={ e => handleSubmit( e ) }>
                        <div  className='grid grid-cols-1 items-center gap-2 px-4 py-6'>
                            ...
                            {/* Password */ }
                            <div>
                                <label  className='label-text text-slate-600 text-sm' htmlFor="password">{ t( 'Password' ) } <span  className="text-red-600">*</span></label>
