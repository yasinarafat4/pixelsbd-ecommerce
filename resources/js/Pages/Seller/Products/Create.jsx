...
export default function Create({ categoryList, attributeList, attributeValueList, colorsList, brandList }) {
    ...
    function handleSubmit(e) {
        ...
        post(route('seller.product.products.store'));
    }
                                                ...
                                                {hasVariant == true ?
                                                    <>
                                                        <div  className="flex flex-col items-center gap-4">
                                                            ...
                                                            {/* Attributes */}
                                                            <div  className="w-full">
                                                                <label  className='label-text text-slate-600 text-sm font-medium' htmlFor="attribute">{t('Attributes')} <span  className="text-blue-600 text-[12px]">{('( Choose the attributes of this product and then input values of each attribute)')}</span></label>
                                                                <Select
                                                                    isMulti
                                                                    id="attribute"
                                                                    name="attribute"
