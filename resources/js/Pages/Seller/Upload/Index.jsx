...
export default function Index() {
    ...
    function onImageDelete(id) {
        router.delete(route('seller.upload.destroy', id))
    }
        ...
        <SellerLayout>
            ...
            <div  className='px-2'>
                <div  className='flex justify-between items-center my-5'>
                    ...
                    {/* Create button */}
                    <div>
                        <Link href={route('seller.upload.create')}>
                                        ...
                                        <div key={i}  className="relative bg-white shadow-xl rounded-md border">
                                            ...
                                            <div  className="pt-1 pb-2 px-2 h-16 bg-slate-200">
                                                <div  className="flex justify-between items-end">
                                                    <div>
                                                        <p  className="text-[14px] font-semibold">{img.file_name.slice(0, 18)}</p>
                                                        <p  className="text-[11px] text-slate-500">{img.width}x{img.height}</p>
                                                        <p  className="text-[11px] text-slate-500">{(img.size / 1024).toFixed(2)} KB </p>
                                                    </div>
