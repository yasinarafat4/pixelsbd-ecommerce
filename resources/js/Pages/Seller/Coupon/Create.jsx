...
export default function Create() {
    ...
    function handleSubmit(e) {
        e.preventDefault()
        post(route('seller.coupon.store'))
    }
            ...
            <div  className='p-4'>
                <div  className='flex justify-between items-center my-5'>
                    ...
                    <div  className="text-sm breadcrumbs text-slate-600">
                        <ul>
                            <li>
                                <a href={route('seller.coupon.index')}  className="inline-flex gap-1 items-center">
                        ...
                        <div  className='grid grid-cols-1 items-center gap-2'>
                            ...
                            {data.type && <div  className="px-6">
                                ...
                                <div  className="flex justify-end">
                                    <button type="submit"  className="bg-sky-500 hover:bg-sky-600 duration-300 py-2 px-4 rounded-md text-white">{t('Save')}</button>
                                </div>
                            </div>}
