...
export default function Index() {
    ...
    const deleteData = (id) => {
        router.delete(route('seller.coupon.destroy', id))
    }
    ...
    function onUpdateCouponStatus(e, id) {
        router.put(route('seller.update_coupon_status', id), {
        ...
        <SellerLayout>
            ...
            <div  className='p-4'>
                <div  className='flex justify-between items-center my-5'>
                    ...
                    {/* Create button */}
                    <div>
                        <Link href={route('seller.coupon.create')}>
                                    ...
                                    {coupons.data.map((coupon, i) => {
                                        ...
                                        return <tr key={i}  className='text-slate-600'>
                                            ...
                                            <td align="center"  className="space-x-2">
                                                <Link href={route('seller.coupon.edit', coupon.id)}> <div data-tip={t('Edit')}  className="tooltip cursor-pointer p-[10px] text-blue-600 hover:text-slate-200 bg-blue-100 hover:bg-blue-600 duration-500 rounded-full">
