...
export default function ProductList({ label, products, minimum_price, maximum_price, colors }) {
    ...
    function onSortByChange(e) {
        ...
        router.visit(route('product_list', [{ 'type': type, 'sort_by': e.target.value, 'min_price': min_price, 'max_price': max_price, 'color': color_name }]))
    }

    // filter by price range
    function onInput(e) {
        setRangeValue(e)
        router.visit(route('product_list', [{ 'type': type, 'sort_by': sort_by, 'min_price': e[0], 'max_price': e[1], 'color': color_name }]))
    }
    ...
    function onColorClick(color) {
        if (color_name == color) {
            setSelectedColor('');
            router.visit(route('product_list', [{ 'type': type, 'sort_by': sort_by, 'min_price': min_price, 'max_price': max_price }]))
        } else {
            setSelectedColor(color);
            router.visit(route('product_list', [{ 'type': type, 'sort_by': sort_by, 'min_price': min_price, 'max_price': max_price, 'color': color }]))
        }
    }
