...
import { placeholder4_2 } from "@/Helpers";
...
export default function Edit({ blogCategories, blog }) {
    const { t } = useLaravelReactI18n();

    const [selectedBlogCategory, setSelectedBlogCategory] = useState({ label: blog.blog_category.name, value: blog.blog_category.id });
    ...
    function handleSubmit(e) {
        e.preventDefault()
        put(route('admin.blog.blogs.update', blog))
    }
            ...
            <div className='p-4'>
                ...
                <div className='card rounded shadow bg-white border-[1px] border-slate-200 py-5 max-w-7xl mx-auto'>
                    <div className="flex items-center justify-between border-b pb-3 px-6">
                        <h2 className="text-lg font-medium text-slate-600">{t('Update Blog Information')}</h2>
                    </div>
                            ...
                            <div className='flex flex-col w-full'>
                                ...
                                <div className="w-full">
                                    ...
                                    <div className="flex items-center gap-3">
                                        {data.blog_banner && <div className="relative">
                                ...
                                <div className="w-full">
                                    ...
                                    <div className="flex items-center gap-3">
                                        {data.meta_image && <div className="relative">
                                            ...
                                            <img className='w-32 h-32 border rounded-xl p-3 mt-3' src={data.meta_image} alt={'meta_image'} />
                                        </div>}
                                    </div>
                                </div>
                            </div>
