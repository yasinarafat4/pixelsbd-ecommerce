...
export default function View ( { order, delivery_boy_list } )
{
    ...
    const { default_currency_symbol, business_settings } = usePage().props
    // const [ deliveryBoyAddon, setDeliveryBoyAddon ] = useState( false )
    ...
    function onDeliveryBoyChange ( e )
    {
        ...
        router.post( route( 'admin.orders.delivery-boy-assign' ), {
            order_id: order.id,
    ...
    function onDeliveryStatusChange ( e )
    {
        ...
        router.visit( route( 'admin.orders.update_delivery_status' ), {
            method: 'post',
            data: {
                'order_id': order.id,
                'status': e.value
    ...
    function onPaymentStatuChange ( e )
    {
        ...
        router.visit( route( 'admin.orders.update_payment_status' ), {
            method: 'post',
            data: {
                'order_id': order.id,
                'status': e.value
            ...
            <div  className='p-4'>
                ...
                <div  className="card bg-white border-[1px] border-slate-200 p-5 space-y-4">
                    <div  className="flex justify-end">
                        { ( business_settings.product_manage_by_admin || order.seller?.user_type == 'admin' ) && <div  className=" flex items-center w-7/12 gap-5">
                    ...
                    <div  className="border px-3 lg:px-6">
                        ...
                        <div  className="flex justify-end items-center pb-6">
                            <a href={ route( 'admin.invoice_download', order.id ) }  className="py-3 px-5 rounded bg-black flex justify-center items-center text-white w-[55px]">
                                <LuPrinter />
                            </a>
                        </div>
                    </div>
