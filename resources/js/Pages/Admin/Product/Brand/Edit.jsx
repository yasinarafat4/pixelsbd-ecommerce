...
export default function Edit ( { lang, brand } )
{
    ...
    {
        e.preventDefault()
        put( route( 'admin.product.brand.update', brand.id ) )
    }
                    ...
                    <div  className="flex items-center">
                        {
                            active_languages.map( ( language, i ) => (
                                ...
                                <a key={ i } href={ route( 'admin.product.brand_edit', { id: brand.id, lang: language.code } ) }  className={ lang == language.code ? 'text-center border py-3 bg-[#3390F3] text-white duration-500 grow' : 'text-center border py-3 hover:bg-[#3390F3] hover:text-white duration-500 grow' }>{ language.name }</a>
                            ) )
                        }
                    </div>
                                ...
                                <div  className="w-full">
                                    ...
                                    <div  className="flex items-center gap-3">
                                        { data.logo && <div  className="relative">
                                            ...
                                            <img  className='w-32 h-32 border rounded-xl p-3 mt-3' src={ data.logo } alt={ 'Logo' } />
                                        </div> }
                                    </div>
                                </div>
                            </div>
