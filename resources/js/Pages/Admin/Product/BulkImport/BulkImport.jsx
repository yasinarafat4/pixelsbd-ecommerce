            ...
            <div  className='p-4'>
                ...
                <div  className='card rounded-lg shadow bg-white border-[1px] border-slate-200 mt-4'>
                    ...
                    <div  className='card-body px-5 space-y-5'>
                        ...
                        <div  className="space-y-4">
                            ...
                            <button  className="bg-[#8F60EE] hover:bg-[#2180A0] duration-300 px-5 py-2 rounded text-white">Download CSV</button>
                        </div>
                        {/* Step Two */}
                        <div  className="space-y-4">
                            <div  className="space-y-2 text-sm bg-[#CCE5FF] rounded-md p-5 border border-[#b5d3f5]">
                            ...
                            <div  className="flex flex-col md:flex-row justify-center md:justify-start items-center gap-4">
                                <button  className="bg-[#8F60EE] hover:bg-[#2180A0] duration-300 px-5 py-2 rounded text-white">Download Category</button>
                                <button  className="bg-[#8F60EE] hover:bg-[#2180A0] duration-300 px-5 py-2 rounded text-white">Download Brand</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div  className='card rounded-lg shadow bg-white border-[1px] border-slate-200 mt-4'>
                    ...
                    <div  className='card-body px-5 space-y-5'>
                        ...
                        <button  className="bg-[#8F60EE] hover:bg-[#2180A0] duration-300 px-5 py-2 rounded text-white w-[130px]">Upload CSV</button>
                    </div>
                </div>
            </div>
        </AdminLayout>
