                    ...
                    <form onSubmit={ handleSubmit }>
                        <div  className='grid grid-cols-1 items-center gap-2 px-4 py-6'>
                                ...
                                <div  className="w-full">
                                    ...
                                    <div  className="flex items-center gap-3">
                                        { data.image && <div  className="relative">
                                            <IoMdClose onClick={ () => { removeImage() } }  className="text-xl text_primary absolute top-2 -right-1 cursor-pointer p-1 bg-blue-200 rounded-full" />
                            ...
                            <div>
                                ...
                                <div  className='h-60'>
                                    <Wysiwyg defaultValue="" placeholder="Description" modules={ modules } formats={ formats } onWysiwygChange={ e => handleDescriptionChange( e ) } />
                                </div>
