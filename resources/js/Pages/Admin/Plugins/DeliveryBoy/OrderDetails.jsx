...
import { MdCancelScheduleSend, MdKeyboardDoubleArrowLeft } from "react-icons/md";
            ...
            <div  className='p-8'>
                <div  className='flex justify-between items-center my-5'>
                    ...
                    <div  className="text-sm breadcrumbs text-slate-600">
                        <ul>
                            <li>
                                <a href={route('admin.deliveryboy.cancel_request')}  className="inline-flex gap-1 items-center">
                ...
                <div  className="card bg-white space-y-4">
                    ...
                    <div  className="flex flex-col md:flex-row justify-between gap-4">
                        ...
                        <div>
                            ...
                            <p  className="text-[13px] flex items-center justify-between gap-5"> <span  className="font-semibold">{t('Order date')}</span>  <span>{moment(order.date).format('lll')}</span></p>
                            ...
                            <p  className="text-[13px] flex items-center justify-between gap-5"> <span  className="font-semibold">{t('Payment Status')}</span>  <span  className="px-[5px] py-[2px] bg-emerald-600 text-white rounded">{toCamel(order.payment_status)}</span></p>
                        </div>
                    </div>
                    ...
                    <div  className="border px-3 lg:px-6">
                        ...
                        <div  className="flex justify-end items-center pb-6">
                            <a href={route('admin.deliveryboy.invoice_download', window.btoa(order.id))}  className="py-3 px-5 rounded bg-black flex justify-center items-center text-white w-[55px]">
                                <LuPrinter />
                            </a>
                        </div>
                    </div>
