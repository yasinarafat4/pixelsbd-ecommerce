...
export default function AssignDeliveryBoy() {
    ...
    const { assign_delivery_boy } = usePage().props;

    // form functionality
    const { data, setData, post, processing, errors, reset } = useForm({
        identifier: assign_delivery_boy.identifier,
        sms_body: assign_delivery_boy.sms_body,
        template_id: assign_delivery_boy.template_id ?? '',
        status: assign_delivery_boy.status,
    })
