...
export default function AccounOpening() {
    const { t } = useLaravelReactI18n();
    const { account_opening } = usePage().props;
    // form functionality
    const { data, setData, post, processing, errors, reset } = useForm({
        identifier: account_opening.identifier,
        sms_body: account_opening.sms_body,
        template_id: account_opening.template_id ?? '',
        status: 1,
    })
