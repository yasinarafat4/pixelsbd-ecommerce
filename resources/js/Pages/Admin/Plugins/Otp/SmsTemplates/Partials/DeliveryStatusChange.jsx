...
export default function DeliveryStatusChange() {
    ...
    const { delivery_status_change } = usePage().props;

    // form functionality
    const { data, setData, post, processing, errors, reset } = useForm({
        identifier: delivery_status_change.identifier,
        sms_body: delivery_status_change.sms_body,
        template_id: delivery_status_change.template_id ?? '',
        status: delivery_status_change.status,
    })
