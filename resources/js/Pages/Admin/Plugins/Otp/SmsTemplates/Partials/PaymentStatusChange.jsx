...
export default function PaymentStatusChange() {
    const { t } = useLaravelReactI18n();
    const { payment_status_change } = usePage().props;

    // form functionality
    const { data, setData, post, processing, errors, reset } = useForm({
        identifier: payment_status_change.identifier,
        sms_body: payment_status_change.sms_body,
        template_id: payment_status_change.template_id ?? '',
        status: payment_status_change.status
    })
