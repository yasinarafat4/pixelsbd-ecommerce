...
export default function ProductsWishlist ( { categories } )
{
                    ...
                    <ul>
                        ...
                        <li>
                            <span  className="inline-flex gap-1 items-center">
                                <TbShoppingCartHeart  className="text-lg text-slate-900" />
                                <span>{ t( 'Products Wishlist' ) }</span>
                            </span>
                        </li>
                    </ul>
                </div>
                ...
                <div  className='card rounded-lg bg-white border-[1px] border-slate-300 max-w-7xl mx-auto mt-4'>
                    <div  className="flex items-center justify-between border-b border-slate-300 py-2 px-6">
                        <div  className="basis-2/4">
                            <h2  className="text-lg font-medium text-slate-600">{ t( 'Product Wise Report' ) }</h2>
                        </div>
                        {/* Sort*/ }
                        ...
                        <table  className="table">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th align="left"  className="border border-slate-300 font-bold text-sm text-black">{ t( 'Number of Wish' ) }</th>
                                </tr>
                            </thead>
                            <tbody>
                                {/* Table row */ }
                                ...
                                <tr>
                                    ...
                                    <td  className="border border-slate-300" align="left">Anivia Computer Headsets Over Ear Headphones Wired Gaming Headset with Mic for PC Mac PS4 PS5 Xbox One, Stereo Surround Sound, Purple</td>
                                    <td  className="border border-slate-300" align="left"> 10</td>
                                </tr>
                            </tbody>
                        </table>
