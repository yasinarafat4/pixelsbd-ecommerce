...
export default function ProductsStock ( { categories } )
{
                    ...
                    <ul>
                        ...
                        <li>
                            <span  className="inline-flex gap-1 items-center">
                                <FaBoxOpen  className="text-lg text-slate-900" />
                ...
                <div  className='card rounded-lg bg-white border-[1px] border-slate-300 max-w-7xl mx-auto mt-4'>
                    <div  className="flex items-center justify-between border-b border-slate-300 py-2 px-6">
                        <div  className="basis-2/4">
                            <h2  className="text-lg font-medium text-slate-600">{ t( 'Product Wise Stock Report' ) }</h2>
                        </div>
                        {/* Sort*/ }
                        ...
                        <table  className="table">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th align="left"  className="border border-slate-300 font-bold text-sm text-black">{ t( 'Stock' ) }</th>
                                </tr>
                            </thead>
                            <tbody>
                                {/* Table row */ }
