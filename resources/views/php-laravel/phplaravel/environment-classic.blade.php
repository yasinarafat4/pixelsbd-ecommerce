...
@section('title')
    <i class="fa fa-code fa-fw" aria-hidden="true"></i> {{ trans('default_messages.environment.classic.title') }}
@endsection

@section('container')

    <form method="post" action="{{ route('PhpLaravel::environmentSaveClassic') }}">
        {!! csrf_field() !!}
    ...
    @if( ! isset($environment['errors']))
        <div class="buttons-container">
            <a class="button float-left" href="{{ route('PhpLaravel::environmentWizard') }}">
                <i class="fa fa-sliders fa-fw" aria-hidden="true"></i>
                {!! trans('default_messages.environment.classic.back') !!}
            </a>
            <a class="button float-right" href="{{ route('PhpLaravel::database') }}">
