                                                                ...
                                                                <tr>
                                                                    <td class="text-header right"
                                                                        ...
                                                                        <a href="{{ env('APP_URL') }}" target="_blank"
                                                                            rel="noreferrer" class="link"
                                                                            style="color:#000001; text-decoration:none;"><span
                                                                                class="link"
                                                                                style="color:#000001; text-decoration:none;">{{ get_settings('website_name') }}</span></a>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </th>
                                                        ...
                                                        <tr>
                                                            <td class="h5 center blue pb30"
                                                                ...
                                                                <a href="{{ $array['link'] }}"
                                                                    ...
                                                                    target="_blank">{{ trans('Click Here') }}</a>
                                                            </td>
                                                        </tr>
                                                    @endif
                                                </table>
