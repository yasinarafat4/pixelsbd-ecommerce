        ...
        (function(e, t) {
            ...
            e.rails = n = {
                ...
                handleRemote: function(r) {
                    ...
                    if (n.fire(r, "ajax:before")) {
                        u = r("cross-domain");
                        a = u === t ? null : u;
                        f = r("with-credentials") || null;
                        l = r("type") || e.ajaxSettings && e.ajaxSettings.dataType;
                        if (r.is("form")) {
                            i = r.attr("method");
                            s = r.attr("action");
                            o = r.serializeArray();
                            var h = r("ujs:submit-button");
                            if (h) {
                                o.push(h);
                                r("ujs:submit-button", null)
                            }
                        } else if (r.is(n.inputChangeSelector)) {
                            i = r("method");
                            s = r("url");
                            o = r.serialize();
                            if (r("params")) o = o + "&" + r("params")
                ...
                enableFormElement: function(e) {
                    var t = e.is("button") ? "html" : "val";
                    if (e("ujs:enable-with")) e[t](e("ujs:enable-with"));
                ...
                disableElement: function(e) {
                    e("ujs:enable-with", e.html());
                    e.html(e("disable-with"));
                    e.bind("click.railsDisable", function(e) {
                        return n.stopEverything(e)
                    })
                },
                enableElement: function(e) {
                    if (e("ujs:enable-with") !== t) {
                        e.html(e("ujs:enable-with"));
            ...
            if (n.fire(r, "rails:attachBindings")) {
                ...
                r.delegate(n.formInputClickSelector, "click.rails", function(t) {
                    ...
                    r.closest("form")("ujs:submit-button", s)
                });
        ...
        jQuery(document).ready(function($) {
            ...
            $.ajaxSetup({
                beforeSend: function(xhr, settings) {
                    settings += "&_token=<?php echo csrf_token() ?>";
                }
            });
